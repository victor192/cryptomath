<template>
  <div class="login-content">
    <ui-card class="login-content__form">
      <h5 class="login-content__form_title fonts__h5">
      ...
      <div class="login-content__form_fields">
        ...
        <!-- Email -->
        <ui-form-group label-for="email" class="field">
          <template slot="label">
        ...
        <!--  Password  -->
        <ui-form-group label-for="password" class="field">
          <template slot="label">
            <div class="password-label">
              ...
              <nuxt-link :to="localePath('/auth/reminder')">
                {{ $t("auth.login.form.password.reminder") }}
              </nuxt-link>
            </div>
          </template>
          <template slot="input">
            <transition name="fade">
              <ui-form-alert v-if="errors.password">
                <span class="fonts__text2">{{
                  $t("auth.login.form.password.error")
                }}</span>
              </ui-form-alert>
            </transition>
            <ui-form-input
        ...
        <div class="login-content__form_buttons">
          <ui-button :variant="['primary']" @click.native="submitLogin">
            {{ $t("auth.login.form.login") }}
          </ui-button>
        </div>
      </div>
    </ui-card>
    <ui-card class="login-content__register" center>
      <i18n path="auth.login.register.text" tag="span" class="fonts__text2">
