<template>
  <div class="tab-organizations">
    ...
    >
      {{ $t('homepage.content.organizations.explore', {count: organizationsTotal}) }}
    </ui-button>
  </div>
</template>
...
<style lang="scss" scoped>
  ...
  .tab-organizations {
    ...
    &__organizations {
      ...
      &_row {
        display: grid;
        grid-template-columns: .8fr 3.2fr 1fr 1fr;
        grid-template-rows: 1fr;
